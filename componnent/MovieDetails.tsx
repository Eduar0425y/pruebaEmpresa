    ...
    return (
      ...
      <div>
        ...
        <div className='row' style={{height: "800px",}}>
          ...
          <a onClick={() => window.location.reload()} id="iconoAtras" className="position-absolute top-10 left-10 z-3" style={{textDecoration:"none", color: "white", cursor: "pointer", margin: "10px"}}>
          ...
          <div className='row position-absolute' style={{display : "flex", justifyContent : "center", alignItems : "center", height: "800px", backgroundImage: "linear-gradient(to right, rgba(0, 0, 0) 10%, rgba(240, 248, 255, 0) 90%)"}}>
            ...
            <div className="col-sm-4 left-10">
              ...
              <p style={{marginLeft: "30px", maxHeight: "400px", overflow: "hidden"}}>
                ...
                <br></br>
                <br></br>
                <a href="#similar"><button className="btn btn-primary" 
                ...
                onClick={(event: any) => {
                  ...
                  document.getElementById("iconoAtras").style.marginTop = "80px"
                  document.getElementById("header").style.top = "0px"

                }}
                >Peliculas similares</button></a>
          ...
          <SimilarMovies idMovie={movie.id} />
